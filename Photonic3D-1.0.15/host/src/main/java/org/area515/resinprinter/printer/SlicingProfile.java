...
public class SlicingProfile implements Named {
	...
	@XmlElement(name="DelayTimeBeforeSolidifyCalculator")
	private String delayTimeBeforeSolidifyCalculator;
	...
	// FIXME: 2018/5/4 zyd add for set sensor detection enabled -s
	@XmlElement(name="DetectionMaterialWeightEnabled")
	private boolean detectionMaterialWeightEnabled;
	@XmlElement(name="DetectionDoorLimitEnabled")
	private boolean detectionDoorLimitEnabled;
	@XmlElement(name="DetectionResinTypeEnabled")
	private boolean detectionResinTypeEnabled;
	@XmlElement(name="DetectionLiquidLevelEnabled")
	private boolean detectionLiquidLevelEnabled;
	// FIXME: 2018/5/4 zyd add for set sensor detection enabled -e
	private String name;
	...
	@XmlTransient
	public String getDelayTimeBeforeSolidifyCalculator() {
		return delayTimeBeforeSolidifyCalculator;
	}
	public void setDelayTimeBeforeSolidifyCalculator(String delayTimeBeforeSolidifyCalculator) {
		this.delayTimeBeforeSolidifyCalculator = delayTimeBeforeSolidifyCalculator;
	}
	// FIXME: 2017/9/15 zyd add for set delay time -e
	...
	// FIXME: 2018/5/4 zyd add for set sensor detection enabled -s
	@XmlTransient
	public boolean getDetectionMaterialWeightEnabled() {
		return detectionMaterialWeightEnabled;
	}
	public void setDetectionMaterialWeightEnabled(boolean detectionMaterialWeightEnabled) {
		this.detectionMaterialWeightEnabled = detectionMaterialWeightEnabled;
	}

	@XmlTransient
	public boolean getDetectionDoorLimitEnabled() {
		return detectionDoorLimitEnabled;
	}
	public void setDetectionDoorLimitEnabled(boolean detectionDoorLimitEnabled) {
		this.detectionDoorLimitEnabled = detectionDoorLimitEnabled;
	}

	@XmlTransient
	public boolean getDetectionResinTypeEnabled() {
		return detectionResinTypeEnabled;
	}
	public void setDetectionResinTypeEnabled(boolean detectionResinTypeEnabled) {
		this.detectionResinTypeEnabled = detectionResinTypeEnabled;
	}

	@XmlTransient
	public boolean getDetectionLiquidLevelEnabled() {
		return detectionLiquidLevelEnabled;
	}
	public void setDetectionLiquidLevelEnabled(boolean detectionLiquidLevelEnabled) {
		this.detectionLiquidLevelEnabled = detectionLiquidLevelEnabled;
	}
	// FIXME: 2018/5/4 zyd add for set sensor detection enabled -e
